...
export default {
  ...
  data: () => ({
    items: [
      { title: 'Company Management', icon: 'mdi-home-city', route: '/company' },
      { title: 'Branch Management', icon: 'mdi-compass', route: '/branch' },
      {
      ...
      { title: 'Check Management', icon: 'mdi-checkbook', route: '/check' }
    ]
  })
}
</script>
